                                    ...
                                    <div class="row">
                                        <div class="block clearfix">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="submit-Beds">小区</label>
                                            ...
                                            <div class="col-md-12 col-sm-12">
                                                <section id="place-on-map">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div id="r-result"style="width: 100%">请输入地址:
                                                            <input type="text" id="suggestId" size="20" value="百度" style="width:80%;"/>
                                                            <button id="getX" type="button">确认地址</button></div>
                                                        <div id="searchResultPanel" style="border:1px solid #C0C0C0;width:150px;height:auto; display:none;" ></div>
                                                        </div>
                                                    <input type="text" id="x" name="x"  value="x" style="display: none" />
                                                    <input type="text" id="y" name="y"  value="y" style="display: none"/>
                                                    <input type="text" id="content" name="content"  value="content" style="display: none" />
                                                    <input type="text" id="address" name="address"  value="address" style="display: none" />
                                                    </div><!-- /.form-group -->
...
<script type="text/javascript">
    ...
    $(getX).click(function(){
        ...
        var dizhi=document.getElementById('suggestId');
        ...
        x.value=pp.lng;
        y.value=pp.lat;
        content.value="地址："+dizhi.value+"<br/><button id='btn'>查看详情</button>";
        address.value=dizhi.value;
        // myform.submit();
    });
