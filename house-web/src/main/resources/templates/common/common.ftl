            ...
            <header class="navbar" id="top" role="banner">
                ...
                <nav class="collapse navbar-collapse bs-navbar-collapse navbar-right" role="navigation">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="has-child"><a href="#">可视化</a>
                            <ul class="child-navigation">
                                <li><a href="/admin/statistics/hot">热门房产</a></li>
                                <li><a href="/admin/statistics/price">价格表</a></li>
                                <li><a href="/admin/statistics/rating">评分图</a></li>
                                <li><a href="/admin/statistics/TreeMap">房产关系图</a></li>
                                <li><a href="/admin/statistics/realtime">在线人数</a></li>
                            </ul>
                        </li>
                        <li><a href="/blog/list">百科</a></li>
                        <li><a href="/house/map">地图找房</a></li>
                        <#if (loginUser.type)?? && (loginUser.type) == 3>
                         <li class="has-child"><a href="#">后台管理</a>
                             <ul class="child-navigation">
                                 <li><a href="/blog/create">写帖子</a></li>
                                 <li><a href="/agency/create">创建经纪机构</a></li>
                             </ul>
                         </li>
                        </#if>
                    </ul>
